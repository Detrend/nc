...
namespace nc
{
  namespace shaders
  {
    ...
    namespace light
    {
      ...
      inline constexpr Uniform<1, u32>  NUM_TILES_X;
      inline constexpr Uniform<2, f32>  AMBIENT_STRENGTH;
      inline constexpr Uniform<3, u32>  NUM_SECTORS;
      inline constexpr Uniform<4, u32>  NUM_WALLS;
      inline constexpr Uniform<5, bool> DO_SHADOWS;
    }
